...
public class AlbumActivity extends AppCompatActivity {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                {
                    Toast.makeText(AlbumActivity.this,"图片上传成功,请稍后查看",Toast.LENGTH_SHORT).show();
                    mNineGridAdapter.notifyDataSetChanged();
                }
                break;
                case 2:
                {
                    Toast.makeText(AlbumActivity.this,"图片上传失败，请重新上传",Toast.LENGTH_SHORT).show();
                }
                break;
                case 3:
                {
                    Toast.makeText(AlbumActivity.this,"图片下载成功",Toast.LENGTH_SHORT).show();
                    mNineGridAdapter.notifyDataSetChanged();
                }
                break;
                case 4:
                {
                    Toast.makeText(AlbumActivity.this,"此相册为空",Toast.LENGTH_SHORT).show();
                }
                break;
                default:
                    Toast.makeText(AlbumActivity.this,"网络错误",Toast.LENGTH_SHORT).show();
    ...
    */
    ...
    private void intiview() {
        ...
        tv_title=(TextView)findViewById(R.id.InAlbum_name);
        btn_back=(ImageView)findViewById(R.id.InAlbum_backbtn);
        btn_newpic=(TextView)findViewById(R.id.InAlbum_newbtn);
    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    ...
                    case TAKE_PICTURE: // 拍照
                        Toast.makeText(AlbumActivity.this, "目前不支持相机拍照上传图片", Toast.LENGTH_SHORT).show();
                        // startCamera();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == MainActivity.RESULT_OK) {
            try {
                mBitmap = MediaStore.Images.Media.getBitmap(AlbumActivity.this.getContentResolver(), data.getData());
            }catch (IOException e)
            {
                e.printStackTrace();
            }
    ...
    private String bitmap2String() {
        ...
        if(mBitmap==null){
            Toast.makeText(AlbumActivity.this, "先选取照片",Toast.LENGTH_SHORT).show();
            return null;
        }
